        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="inmobiliaria" id="inmobiliaria" {{ is_null($cliente->inmobiliaria) ? 'checked' : '' }}>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="ubicacion" id="ubicacion" class="form-control" value="{{ old('ubicacion', $intereses['ubicacion'] ?? '') }}">
                </div>
                <div class="row">
                    <div class="col">
                        <label for="habitaciones_min" class="form-label">Habitaciones mín.</label>
                        <input type="number" name="habitaciones_min" class="form-control" value="{{ old('habitaciones_min', $intereses['habitaciones_min'] ?? '') }}">
                    </div>
                    <div class="col">
                        <label for="habitaciones_max" class="form-label">Habitaciones máx.</label>
                        <input type="number" name="habitaciones_max" class="form-control" value="{{ old('habitaciones_max', $intereses['habitaciones_max'] ?? '') }}">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col">
                        <label for="banos_min" class="form-label">Baños mín.</label>
                        <input type="number" name="banos_min" class="form-control" value="{{ old('banos_min', $intereses['banos_min'] ?? '') }}">
                    </div>
                    <div class="col">
                        <label for="banos_max" class="form-label">Baños máx.</label>
                        <input type="number" name="banos_max" class="form-control" value="{{ old('banos_max', $intereses['banos_max'] ?? '') }}">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col">
                        <label for="m2_min" class="form-label">M2 mín.</label>
                        <input type="number" name="m2_min" class="form-control" value="{{ old('m2_min', $intereses['m2_min'] ?? '') }}">
                    </div>
                    <div class="col">
                        <label for="m2_max" class="form-label">M2 máx.</label>
                        <input type="number" name="m2_max" class="form-control" value="{{ old('m2_max', $intereses['m2_max'] ?? '') }}">
                    </div>
                </div>
                <div class="mt-3">
                    ...
                    <select name="estado" class="form-select">
                        ...
                        <option value="Obra nueva" {{ old('estado', $intereses['estado'] ?? '') === 'Obra nueva' ? 'selected' : '' }}>Obra nueva</option>
                        <option value="Buen estado" {{ old('estado', $intereses['estado'] ?? '') === 'Buen estado' ? 'selected' : '' }}>Buen estado</option>
                        <option value="A reformar" {{ old('estado', $intereses['estado'] ?? '') === 'A reformar' ? 'selected' : '' }}>A reformar</option>
                    </select>
                </div>
                <div class="mt-3">
                    ...
                    <select name="disponibilidad" class="form-select">
                        <option value="">-- Selecciona --</option>
                        <option value="Alquiler" {{ old('disponibilidad', $intereses['disponibilidad'] ?? '') === 'Alquiler' ? 'selected' : '' }}>Alquiler</option>
                        <option value="Venta" {{ old('disponibilidad', $intereses['disponibilidad'] ?? '') === 'Venta' ? 'selected' : '' }}>Venta</option>
                    </select>
                </div>
                <div class="mt-3">
                    ...
                    <div class="border rounded p-3" style="max-height: 150px; overflow-y: auto;">
                        ...
                        @foreach ($caracteristicas as $caracteristica)
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="otras_caracteristicasArray[]" value="{{ $caracteristica->id }}" id="carac{{ $caracteristica->id }}"
