        ...
        <div class="container-fluid col-12">
            ...
            <ul class="navbar-nav me-auto mb-0 mb-lg-0 col order-2">
                ...
                @if (Request::session()->get('inmobiliaria') == 'sayco')
                    <li class="ms-auto nav-item">
                        @if (Request::is('seleccion'))
                            <a class="btn btn-light text-dark " href="{{ route('home', ['boton' => 'sancer']) }}">
                                <i class="fas fa-arrows-rotate"></i>
                                <strong>Ir a SANCER</strong>
                            </a>
                        @else
                            <a class="btn btn-outline-light" href="{{ route('home', ['boton' => 'sancer']) }}">
                                <i class="fas fa-arrows-rotate"></i>
                                <strong>Ir a SANCER</strong>
                            </a>
                        @endif
                ...
                @else
                    <li class="ms-auto nav-item">
                        @if (Request::is('seleccion'))
                            <a class="btn btn-light text-dark " href="{{ route('home', ['boton' => 'sayco']) }}">
                                <i class="fas fa-arrows-rotate"></i>
                                <strong>Ir a SAYCO</strong>
                            </a>
                        @else
                            <a class="btn btn-outline-light" href="{{ route('home', ['boton' => 'sayco']) }}">
                                <i class="fas fa-arrows-rotate"></i>
                                <strong>Ir a SAYCO</strong>
                            </a>
                        @endif
