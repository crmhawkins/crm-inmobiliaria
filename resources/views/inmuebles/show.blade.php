...
<div class="container my-4">
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="mb-3">
              @if (isset($imagenes[0]))
                    <img src="{{ $imagenes[0] }}" class="img-fluid rounded w-100" style="max-height: 450px; object-fit: cover;">
                @endif
            </div>
            <div class="d-flex flex-wrap gap-2 mb-4">
                @foreach($imagenes as $img)
                    <img src="{{ $img }}" class="rounded" width="120" height="90" style="object-fit: cover;">
                @endforeach
            ...
            <div class="mb-3 d-flex flex-wrap gap-4 fs-5">
                ...
                @if($inmueble->has_terrace) <div><i class="bi bi-tree"></i> Terraza</div> @endif
                @if($inmueble->has_balcony) <div><i class="bi bi-columns-gap"></i> Balcón</div> @endif
            </div>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm mb-3">
                <div class="card-body">
                    ...
                    <a href="mailto:{{ config('app.contacto_email') }}" class="btn btn-primary w-100">
